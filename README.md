...
当前视觉由高密度点云重建主体，粒子本身负责呈现人像和场景；原图只以默认 0.06 的极弱连续性层防止暗部断裂，不会盖住粒子。指针经过画面会形成引力井、亮环和漩涡，按住并拖动可以让整张点云产生 3D 俯仰/侧转，松手后带阻尼回正；声音和音乐继续驱动深度波、呼吸与闪光。`Image continuity` 只用于少量补偿特别暗的照片。
