...
右上角设置面板可以切换 AI Brain、回复语言、浏览器音色风格、图片理解开关、本机原声保存开关、粒子舞动强度、原图清晰度和鼠标力场强度。
...
当前视觉采用“稳定原图核心 + 图内细粒子纹理 + 外围粒子光环”的混合合成：人物主体不会再被完全替换成发光点。若某张照片仍显得过暗，可在右上角设置中调高 `Image clarity`；调低则会得到更抽象、更偏粒子化的效果。
